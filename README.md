...
- **Prices the claiming decision.** The Social Security figure you enter is the one at full retirement age, and the model applies the real adjustment for when you actually claim — 30% off at 62, 24% on at 70, permanently. Move the start age and it tells you what it just cost or bought.
